...
#ifndef VSLAM_FEATURE_MATCHER_PLUGINS__OPTICAL_FLOW_FEATURE_MATCHER_HPP_
#define VSLAM_FEATURE_MATCHER_PLUGINS__OPTICAL_FLOW_FEATURE_MATCHER_HPP_
...
namespace vslam_feature_matcher_plugins {
  ...
  class LKOpticalFlowFeatureMatcher : public virtual vslam_feature_matcher::base::FeatureMatcher {
  public:
    /// Destructor
    ~LKOpticalFlowFeatureMatcher() { std::cerr << "Terminated OpticalFlowFeatureMatcher" << std::endl; }

    /// Feature matcher initializer
    /**
     * \note point type is not applicable here.
     */
    ...
    /// Get the plugin name
    inline std::string getPluginName() override { return "vslam_feature_matcher_plugins::OpticalFlowFeatureMatcher"; }
...
#endif  // VSLAM_FEATURE_MATCHER_PLUGINS__OPTICAL_FLOW_FEATURE_MATCHER_HPP_
