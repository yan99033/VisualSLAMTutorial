...
\begin{lstlisting}
  ...
  # if len(matches) > num_matches_thresh:
  #   publish frame_pair
  @\textbf{loop\_matching\_callback}@(vslam_msgs/FramePair) $\rightarrow$ 
    vslam_msgs/FramePair to @\textbf{loop\_tracking\_callback}@

\end{lstlisting}

TODO:
change frame\_callback and loop\_callback to frame\_matching\_callback and loop\_matching\_callback 
