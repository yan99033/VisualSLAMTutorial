...
\begin{itemize}
  ...
  \item \textbf{back\_end\_node} has two main responsibility: provide the current keyframe and optimize the graph based on the constraints given by the \textbf{tracking\_node}.
