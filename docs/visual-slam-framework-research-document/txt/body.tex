...
\begin{itemize}
  ...
  \item \textbf{vslam\_msgs/AddKeyFrameToPlaceRecognitionDb}
  \begin{verbatim}
...
\begin{lstlisting}
  ...
  @\textbf{frame\_callback}@(vslam_msgs/Frame) $\rightarrow$ vslam_msgs/Frame
\end{lstlisting}
...
\begin{lstlisting}
  ...
  #   set the state as attempt_initialization
  #   return
  ...
  #   candidate_frame_id $\leftarrow$ Find a candidate keyframe
  ...
  #     publish frame_pair to @\textbf{track\_pose12}@
  @\textbf{frame\_callback}@(vslam_msgs/Frame) $\rightarrow$ vslam_msgs/FramePair
  ...
  # if len(matches) > num_matches_thresh:
  #   publish frame_pair
  @\textbf{place\_recognition\_callback}@(vslam_msgs/FramePair) $\rightarrow$ 
...
\begin{lstlisting}
  ...
  #         database for loop closure detection 
...
\begin{lstlisting}
  # Find the candidate 
  @\textbf{place\_recognition\_callback}@
\end{lstlisting}
